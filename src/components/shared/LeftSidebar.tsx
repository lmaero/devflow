...
function LeftSidebar() {
  ...
  return (
    <section className='sticky top-0 left-0 flex max-sm:hidden h-screen flex-col justify-between gap-6 overflow-y-auto border-r p-6 pt-36 background-light900_dark200 light-border shadow-light-300 custom-scrollbar dark:shadow-none lg:w-[266px]'>
          ...
          <Link href='/sign-in'>
            <Button className='w-full rounded-lg px-4 py-3 shadow-none small-medium btn-secondary min-h-[41px]'>
              <Image
                ...
                width={20}
                height={20}
                className='invert-colors max-lg: lg:hidden'
              />
